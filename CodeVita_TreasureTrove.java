 ...
 * @author Abhishek
 */
public class CodeVita_TreasureTrove {
 public static void main(String[] args) {        
    ...
    public static void travers(char mat[][],int n,int count){
...
// right to left
    ...
    //}
      // System.out.println("\n loop End  total square = "+k +" String  "+sb.toString() );
         changMatSqt(mat, sb, n, count, k);
    }
    public static void changMatSqt(char mat[][],StringBuffer sb,int n,int count,int k){
       int xposition=0;
       if(k<0)
