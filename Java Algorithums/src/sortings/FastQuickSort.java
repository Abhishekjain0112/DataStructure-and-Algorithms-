...
public class FastQuickSort {
    ...
    static void quickSort(int []arr,int start,int end){
        ...
        if(start<end){
            ...
            quickSort(arr, start, pivote[0]-1);
            quickSort(arr, pivote[1]+1, end);
      ...
      for(int i=start+1;i<=end;i++){
       ...
       for(int i=start;i<=end;i++){
        ...
        int[] m ={m1,j};
             ...
             System.out.println("Quick Sort "+ Arrays.toString(arr)+" start ind :"+start +" end : "+end+"  pivot :"+pivot+"arr :"+Arrays.toString(m));    
